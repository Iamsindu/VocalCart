...
//                         <Button component={Link} to={HOME} sx={{ my: 2, color: 'black', display: 'block' }}>
//                             Home
//                         </Button>
//                         <Button component={Link} to={SHOP} sx={{ my: 2, color: 'black', display: 'block' }}>
//                             Shop
//                         </Button>
//                     </Box>
//                     <Box sx={{ flexGrow: 0 }}>
...
//                                 <ShoppingOutlined style={{ color: 'black', fontSize: '1.5rem' }} />
//                             </Badge>
//                         </Stack>
//                     </Box>
//                 </Toolbar>
